...
void mk_IsoTrack(string era = "24F", string version = "local") {
  ...
  if (era=="24CDEFGHI") {
    ...
    hybridCorrFact("rootfiles/CorrFact_hybrid_lxplus_v18_24CDEFGHI.root",
		   "rootfiles/CorrFact_lxplus_v18_24CDEFGHI.root",
		   "rootfiles/CorrFact_abs_lxplus_v18_24CDEFGHI.root");
    hybridCorrFact("rootfiles/CorrFact_even_hybrid_lxplus_v18_24CDEFGHI.root",
		   "rootfiles/CorrFact_even_lxplus_v18_24CDEFGHI.root",
		   "rootfiles/CorrFact_even_abs_lxplus_v18_24CDEFGHI.root");
    hybridCorrFact("rootfiles/CorrFact_odd_hybrid_lxplus_v18_24CDEFGHI.root",
		   "rootfiles/CorrFact_odd_lxplus_v18_24CDEFGHI.root",
		   "rootfiles/CorrFact_odd_abs_lxplus_v18_24CDEFGHI.root");
