...
#ifdef IsoTrack_cxx
IsoTrack::IsoTrack(TTree *tree) : fChain(0) 
{
...
Int_t IsoTrack::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t IsoTrack::LoadTree(Long64_t entry)
{
...
void IsoTrack::Show(Long64_t entry)
{
...
Int_t IsoTrack::Cut(Long64_t entry)
{
